...
export CC_PACKAGE_ID_MEDICAL=medical_1.0.1:ecfb8396fb04aa21770a04a3981efa1657b39ec6dfa0f4b152686f315be3eb76
peer lifecycle chaincode approveformyorg -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com --tls --cafile "${PWD}/organizations/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem" --channelID "$NAMENETWORK" --name medical --version 1.0.1 --package-id $CC_PACKAGE_ID_MEDICAL --sequence 1

export CC_PACKAGE_ID_ORG=organization_1.0.1:d31686982324941d3ad2e35e4d88ba21fa738902bd3c78800e36d7d5cde90c6c
peer lifecycle chaincode approveformyorg -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com --tls --cafile "${PWD}/organizations/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem" --channelID "$NAMENETWORK" --name organization --version 1.0.1 --package-id $CC_PACKAGE_ID_ORG --sequence 1
